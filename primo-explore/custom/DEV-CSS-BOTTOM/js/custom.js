(function () {
  ...
  app.component('prmTopNavBarLinksAfter', {
    ...
    template :
    '<div class="spacer"><span class="libraryh3lp needs-js">JavaScript disabled</span></div>'
  });
...
// ga('create', 'UA-104389257-1', 'auto');    // Matt's 'Primo - Test' Google Analytics
// ga('create', 'UA-6535939-5', 'auto');         // Primo VU_PLY Google Analytics
ga('create', 'UA-6535939-8', 'auto');      // Primo NEW_UI_TEST Google Analytics
